...
export const HOME_CONTENT = {
      ...
      [
        ...
        ", ",
        {
          ...
          preview: {
            ...
            body: "Apps deploy into a production-grade portal with authentication and permissions already wired in. Even if one app breaks, the rest of the client experience keeps running.",
          },
        },
        ", and ",
        {
      ...
      [
        ...
        ", ",
        {
          ...
          preview: {
            side: "right",
            visual: "permissions",
            body: "For each app, control client access with rules based on plan, industry, or any custom field. Create tiered experiences for trial vs. paying clients, different industries, and more.",
          },
        },
        ", and ",
        {
      ...
      [
        "And you don't have to build everything yourself. Assembly ships with a ",
        {
          ...
          preview: {
            side: "right",
            visual: "library",
            body: "For example, you can enable our Messages App to let clients communicate with you or our Contracts App for seamless eSignature requests. Our app library has 20 apps and counting.",
          },
        },
        " and an ",
        {
  ...
  testimonials: {
    ...
    quotes: [
      ...
      {
        segment: "Accounting",
        body: "Assembly was the only solution that let us flexibly build our own version of a client portal, uniting elements of their technology with existing external core applications that we wanted to keep using.",
        name: "Kyle Pearson",
        company: "Collective CPA",
        photo: "/testimonials/collective.jpg",
      },
      {
        segment: "Infrastructure",
        body: "Assembly isn't just a portal—it's our infrastructure. We're tying it to Microsoft Azure, automating workflows, and preparing to scale campaigns for massive organizations.",
        name: "Carlos Williams",
        company: "Ditto",
        photo: "/testimonials/ditto.jpg",
      },
      {
        segment: "Customization",
        body: "We were trying to find something that we could customize because we did entertain making our own custom portal… we found Assembly instead.",
        name: "Rachel Hugenschmidt",
        company: "Jungle Luxe",
        photo: "/testimonials/jungle-luxe.jpg",
      },
    ],
  },
